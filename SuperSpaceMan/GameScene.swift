...
class GameScene: SKScene { //extends SKScene and implements two init() methods
   ...
   // let orbNode = SKSpriteNode(imageNamed: "PowerUp") //add the orb sprite to the GameScene at a position ("REMOVED IN CHAPTER 4")
    var impulseCount = 4
...
//
//        foregroundNode.addChild(orbNode) //added to the new foregroundNode
        //orbNode ("REMOVED IN CHAPTER 4")
...
//Summary
//In Chapter 4, i learn to add some real functionality to your game. Began by making some small restructuring changes to the beginning of the game. Then, added additional orbNodes to collide with. After adding the new orbNodes, added scrolling to the game scene, making it look like the player was flying through space collecting orbs. Finally, using the phone’s accelerometer to move the player along the x-axis.
